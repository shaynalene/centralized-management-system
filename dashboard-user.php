  ...
  <body class="hold-transition sidebar-mini layout-fixed">
    <div class="wrapper">
      ...
      <aside class="main-sidebar sidebar-dark-primary elevation-4">
        <!-- Brand Logo -->
        <a href="../centralized-service-system/dashboard-user.php" class="brand-link">
          <img
        ...
        <div class="sidebar">
          ...
          <div class="user-panel mt-3 mb-3 pt-3 pb-3 d-flex">
            <div class="image">
              <a href="../centralized-service-system/pages/user-account-information.php">
                <?php echo $display ?>
              </a>
            </div>

            <div class="info pt-3">
              <a href="../centralized-service-system/pages/user-account-information.php" class="user-name d-block fw-bold text-center fs-4 text-wrap"
                ><?php echo $name ?></a
              >
          ...
          <nav class="mt-2">
            ...
            <li class="nav-item mb-3 mt-3">
              ...
              <li class="nav-item menu-open">
                <a href="../centralized-service-system/dashboard-user.php" class="active-link nav-link active">
              ...
              <li class="nav-item">
                ...
                <ul class="nav nav-treeview">
                  <li class="nav-item">
                    <a href="../centralized-service-system/pages/transaction-history.php" class="nav-link">
                      <i class="far fa-circle nav-icon"></i>
                      <p>Transaction History</p>
                    </a>
                  </li>
                  <li class="nav-item">
                    <a href="../centralized-service-system/pages/permit-req.php" class="nav-link">
                      <i class="far fa-circle nav-icon"></i>
                      <p class="text-center">Document Requisition</p>
                    </a>
                  </li>
                  <li class="nav-item">
                    <a href="../centralized-service-system/pages/user_side-complaint.php" class="nav-link">
                      <i class="far fa-circle nav-icon"></i>
                      <p>File a Complaint</p>
                    </a>
                  </li>
                  <li class="nav-item">
                    <a href="../centralized-service-system/pages/user-feedback.php" class="nav-link">
                      <i class="far fa-circle nav-icon"></i>
                      <p>Send Feedbacks</p>
                    </a>
                  </li>
