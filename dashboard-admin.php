  ...
  <body class="hold-transition sidebar-mini layout-fixed">
    <div class="wrapper">
      ...
      <aside class="main-sidebar sidebar-dark-primary elevation-4">
        <!-- Brand Logo -->
        <a href="../centralized-service-system/dashboard-admin.php" class="brand-link">
          <img
        ...
        <div class="sidebar pb-5">
          ...
          <div class="user-panel mt-3 mb-3 pt-3 pb-3 d-flex">
            <div class="image">
              <a href="../centralized-service-system/pages/admin-account-information.php">
                <?php echo $display ?>
              </a>
            </div>

            <div class="info pt-3">
              <a href="../centralized-service-system/pages/admin-account-information.php" class="user-name d-block fw-bold text-center fs-4 text-wrap"
                ><?php echo $name ?></a
              >
          ...
          <nav class="mt-2">
            ...
            >
              <li class="nav-item mb-3 mt-3 overflow-hidden">
              ...
              <li class="nav-item menu-open">
                <a href="../centralized-service-system/dashboard-admin.php" class="active-link nav-link active">
              ...
              <li class="nav-item">
                ...
                <ul class="nav nav-treeview">
                  <li class="nav-item">
                    <a href="../centralized-service-system/pages/admin_side-complaint_records.php" class="nav-link">
                      <i class="far fa-circle nav-icon"></i>
                      <p>Complaint Records</p>
                    </a>
                  </li>
                  <li class="nav-item">
                    <a href="../centralized-service-system/pages/admin-permit-requests.php" class="nav-link">
                      <i class="far fa-circle nav-icon"></i>
                      <p class="text-center">Permit Requests</p>
                    </a>
                  </li>
                  <li class="nav-item">
                    <a href="../centralized-service-system/pages/admin-clearance-requests.php" class="nav-link">
                      <i class="far fa-circle nav-icon"></i>
                      <p>Clearance Requests</p>
                    </a>
                  </li>
                  <li class="nav-item">
                    <a href="../centralized-service-system/pages/admin-id-requests.php" class="nav-link">
                      <i class="far fa-circle nav-icon"></i>
                      <p>Barangay ID Requests</p>
                    </a>
                  </li>
                  <li class="nav-item">
                    <a href="../centralized-service-system/pages/admin-cert-requests.php" class="nav-link">
                      <i class="far fa-circle nav-icon"></i>
                      <p>Cert. of Residency Requests</p>
                    </a>
                  </li>
                  <li class="nav-item">
                    <a href="../centralized-service-system/pages/admin-feedback.php" class="nav-link">
                      <i class="far fa-circle nav-icon"></i>
              ...
              <li class="nav-item">
                ...
                <ul class="nav nav-treeview">
                  <li class="nav-item">
                    <a href="../centralized-service-system/pages/accounts-list.php" class="nav-link">
                      <i class="far fa-circle nav-icon"></i>
                      <p>Accounts List</p>
                    </a>
                  </li>
                  <li class="nav-item">
                    <a href="../centralized-service-system/pages/admin_side-resident_population.php" class="nav-link">
                      <i class="far fa-circle nav-icon"></i>
                      <p class="text-center">Resident Population</p>
                    </a>
                  </li>
                  <li class="nav-item">
                    <a href="../centralized-service-system/pages/admin_side-commercial_population.php" class="nav-link">
                      <i class="far fa-circle nav-icon"></i>
                      <p>Commercial Population</p>
                    </a>
                  </li>
                  <li class="nav-item">
                    <a href="../centralized-service-system/pages/admin_side-announcements_record.php" class="nav-link">
                      <i class="far fa-circle nav-icon"></i>
                      <p>Announcements</p>
                    </a>
                  </li>
        ...
        <!-- /.card -->
            ...
            <div class="row p-5">
              ...
              <div class="col-md-12 col-lg-6 col-xl-12 p-4">
                <p class="card-text p-5 text-justify"">
                In Barangay 1234, we envision a future where the bonds of kinship and solidarity strengthen our community, and where diversity is embraced as a source of strength. We aspire to be a beacon of excellence and innovation, setting the standard for inclusive and participatory governance. Our vision is of a barangay where infrastructure meets the needs of our residents, where economic opportunities abound, and where environmental sustainability is a cornerstone of our development efforts. We see Barangay 1234 as not just a place on the map but as a home where generations thrive, where dreams are nurtured, and where the legacy of our shared heritage is cherished and passed on with pride.
                </p>
              </div>
            </div>
