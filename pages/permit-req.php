            ...
            <a href="#" class="nav-link logout-btn d-flex align-items-center overflow-hidden">
              ...
              <li class="nav-item menu-open">
                ...
                <ul class="nav nav-treeview">
                  ...
                  <li class="nav-item">
                    <a href="../pages/permit-req.php" class="active-link nav-link active">
                      <i class="far fa-circle nav-icon"></i>
                  ...
                  <li class="nav-item">
                    <a href="../pages/user-feedback.php" class="nav-link">
                      <i class="far fa-circle nav-icon"></i>
                      <p>Send Feedbacks</p>
                    </a>
                  </li>
          ...
          <div class="container-fluid">
            ...
            <div class="row">
              <div class="trans-title col-md-12 pt-5 pl-5">
                PERMIT AND DOCUMENT REQUISITION
              </div>
              <div class="card-container d-flex justify-content-center">
                <div class="card-ans-form card m-5 col-md-8">
                  ...
                  <!-- /.card-header -->
                  <!-- form start -->
                  <form action="../php/push-request.php" method="POST">
                    <div class="card-body px-5 pt-5 pb-0">
                      <div class="form-group disclaimer">
                        ...
                        <div class="disclaimer-subtitle">
                          Please fill out the following form with your desired
                          document or permit request. We will review your
                      ...
                      <div class="form-group">
                        ...
                        <select class="form-control" id="for" name="for">
                          <option>Self</option>
                          <option>Others: Child</option>
                        </select>
                      </div>
                      <div class="form-group">
                        <label for="document_type">Document/Permit Type</label>
                        <select
                          class="form-control"
                          id="document_type"
                          name="document_type"
                      ...
                      <div class="form-group">
                        <label for="req_reason">Reason For Request</label>
                        <input
                          type="text"
                          class="form-control"
                          id="req_reason"
                          name="req_reason"
                          placeholder="Reason Nature"
                        />
                      </div>

                      <div class="form-group child-input" style="display: none">
                        <hr class="my-5" />
    ...
    <script>
      ...
      document.addEventListener("DOMContentLoaded", function () {
        ...
        function toggleInputFields() {
          var selectBox = document.getElementById("for");
