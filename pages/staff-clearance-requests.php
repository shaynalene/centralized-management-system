            ...
            >
              ...
              <li class="nav-item menu-open">
                ...
                <ul class="nav nav-treeview">
                  ...
                  <li class="nav-item">
                    <a href="../pages/staff-clearance-requests.php" class="active-link nav-link active">
                      <i class="far fa-circle nav-icon"></i>
...
if ($result->num_rows > 0) {
    while($row = $result->fetch_assoc()) {
        ...
        <form method='post' action='../php/clearance-requests.php'>
        <input type='hidden' name='reqNumber' value='";
        echo htmlspecialchars($row['ticket_number']);
        echo"'>           
        <input type='hidden' name='account_id' value='";
        echo htmlspecialchars($row['account_id']);
        echo"'>       
