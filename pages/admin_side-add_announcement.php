            ...
            >
              ...
              <li class="nav-item menu-open">
                ...
                <ul class="nav nav-treeview">
                  ...
                  <li class="nav-item">
                    <a href="../pages/admin_side-announcements_record.php" class="active-link nav-link active">
                      <i class="far fa-circle nav-icon"></i>
                      <p>Announcements</p>
                    </a>
                  </li>
            ...
            <div class="row d-flex justify-content-center">
              ...
              <div class="card-container d-flex justify-content-center">
                <div class="card-ans-form card m-5 col-md-8">
                  ...
                  <!-- /.card-header -->
                  <!-- form start -->
                  <a href="../pages/admin_side-announcements_record.php" class="btn btn-primary float-right">
                            <<< Go Back to Announcement Records
                            </a>
                  <form action="../php/push-announcement.php" method="post" enctype="multipart/form-data">
                    <div class="card-body px-5 pt-5 pb-0">
                      <div class="form-group disclaimer">
                        ...
                        <div class="disclaimer-subtitle">
                          Kindly fill out the form with the required information for posting an announcement.
                        </div>
                      </div>
                      <hr class="my-4" />
                      ...
                      <div class="form-group">
                        <label for="Owner_First_Name">Created By:</label>
                        <input
                          type="text"
                          class="form-control"
                          id="Created_By"
                      ...
                      <div class="form-group">
                        <label for="image">Upload Announcement Photo Here:</label>
