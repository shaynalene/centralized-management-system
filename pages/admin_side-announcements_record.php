      ...
      <div class="content-wrapper">
        ...
        <section class="content">
          <div class="container-fluid">
            ...
            <div class="row">
            <div class="trans-title col-md-12 pt-5 pl-5 pr-5 d-flex align-items-center justify-content-between">
                            ANNOUNCEMENT RECORDS
                            <a href="../pages/admin_side-add_announcement.php" class="btn btn-primary float-right">
                                            ...
                                            <div class="col-sm-12">
                                                <table id="example1" class="table table-bordered table-striped dataTable dtr-inline" aria-describedby="example1_info">
                                                    ...
                                                    <tbody id="transactionBody">
                                                        <?php include '../php/fetch-announcement.php'; ?>
                                                    </tbody>
                                                </table>
                                            </div>
                                        </div>
