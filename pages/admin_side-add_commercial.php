            ...
            >
              ...
              <li class="nav-item menu-open">
                ...
                <ul class="nav nav-treeview">
                  ...
                  <li class="nav-item">
                    <a href="../pages/admin_side-commercial_population.php" class="active-link nav-link active">
                      <i class="far fa-circle nav-icon"></i>
            ...
            <div class="row d-flex justify-content-center">
              ...
              <div class="card-container d-flex justify-content-center">
                <div class="card-ans-form card m-5 col-md-8">
                  ...
                  <!-- /.card-header -->
                  <!-- form start -->
                  <a href="../pages/admin_side-commercial_population.php" class="btn btn-primary float-right">
                            <<< Go Back to Commercial Records
                            </a>
                  <form action="../php/push-commercial.php" method="post" enctype="multipart/form-data">
                  <div class="card-body px-5 pt-5 pb-0">
                      <div class="form-group disclaimer">
                        ...
                        <div class="disclaimer-subtitle">
                          Please fill out the following form with the information of the Commercial Place.
                        </div>
                      </div>
                      <hr class="my-4" />
                      <div class="form-group">
                        <label for="Commercial_Name">Name of Commercial:</label>
                        <input
                          type="text"
                          class="form-control"
                          id="Commercial_Name"
                          name="Commercial_Name"
                          placeholder="Enter Commercial Here"
                        />
                      </div>
                      <div class="form-group">
                        ...
                        <input
                          ...
                          placeholder="EnterOwner First Name"
                        />
                      </div>
                      <div class="form-group">
                        <label for="Owner_Middle_Name">Owner Middle Name:</label>
                        <input
                          type="text"
                          class="form-control"
                      ...
                      <div class="form-group">
                        <label for="image">Upload Recent photo of Commercial Place:</label>
